      ...
      <div className="container">
        <div className="row">
          <div className="footer-col-1 col-md-3 col-sm-12">
              ...
              {/* <span>
                <Image alt="jobBox" src="../../public/assets/imgs/template/icons/facebook.svg" width={30} height={30} />
              </span> */}
          ...
          <div className="footer-col-6 col-md-3 col-sm-12">
            ...
            <div className="mt-15">
                ...
                {/* <Image src="../../public/assets/imgs/template/icons/app-store.png" alt="joxBox" width={30} height={30} />
            
            
                <Image src="../../public/assets/imgs/template/icons/android.png" alt="joxBox" width={30} height={30} />
              */}
            </div>
          </div>
        </div>
